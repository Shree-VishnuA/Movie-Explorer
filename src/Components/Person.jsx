...
function Person({ person = {} }) {
  ...
  return (
    <div className="w-fit max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto bg-white rounded-xl sm:rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:scale-102 flex flex-col h-full">
      ...
      <div className="relative flex-shrink-0">
        <img
          ...
          onError={(e) => {
            ...
            e.target.className =
              "w-full h-40 xs:h-48 sm:h-56 md:h-64 lg:h-72 object-cover bg-gray-100";
          }}
        />
        ...
        <div className="flex flex-col xs:flex-row justify-between items-start xs:items-center gap-2 xs:gap-0 flex-shrink-0 mt-auto">
          ...
          {person?.adult === false && (
            <div className="xs:ml-auto">
              <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-green-100 text-green-700 text-xs rounded-full font-medium">
